...
import { useDataViewModel } from 'src/view_model/inviteRegisterViewModel'
      ...
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
            ...
            />
            <Button
              onClick={viewModel.handleProcessRegisterLoginAndJoinTeam}
              fullWidth
              size='large'
              type='submit'
              variant='contained'
...
InviteRegisterPage.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>
